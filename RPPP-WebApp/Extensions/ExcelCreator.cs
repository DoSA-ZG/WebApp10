...
namespace RPPP_WebApp.Extensions
{
    ...
    {
        /// <summary>
        /// Stvaranje Excel dokumenta
        /// </summary>
        /// <typeparam name="T">Vrsta podatka u datasetu</typeparam>
        /// <param name="data">podaci koji se postavljaju u excel</param>
        /// <param name="worksheetName">Naziv excel datoteke koja se kreira</param>
        /// <returns>Vraca excel datoteku popunjenu podacima</returns>
