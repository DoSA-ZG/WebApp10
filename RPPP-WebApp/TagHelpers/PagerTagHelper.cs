...
{
    /// <summary>
    /// Tag helper za kreiranje vlastitih poveznica na stranice u rezultatu nekog upravljaèa
    ...
    /// te u pogled ukljuèiti vlastitu javascript datoteku *gotopage.js*
    /// </example>
    /// </summary>  
    ...
    public class PagerTagHelper : TagHelper
    {
        ...
        /// <summary>
        /// Stvara oznaku za i-tu stranicu koristeæi *i* kao sadržaj poveznice
        ...
        /// <summary>
        ///  Stvara oznaku za i-tu stranicu koristeæi argument text kao sadržaj poveznice
        /// </summary>
        /// <param name="i">broj stranice</param>
        ...
        private TagBuilder BuildListItemForCurrentPage(int page)
        {
            ...
            input.AddCssClass("pagebox");//da ga se može pronaæi i stilizirati
